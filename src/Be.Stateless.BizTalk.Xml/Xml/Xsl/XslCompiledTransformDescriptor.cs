...
{
	/// <summary>
	/// Wrapper for the <see cref="System.Xml.Xsl.XslCompiledTransform"/> equivalent of a <see cref="TransformBase"/>-derived
	/// transform.
	/// </summary>
	public class XslCompiledTransformDescriptor
	{
		...
		/// </summary>
		/// <param name="builder">
		/// An <see cref="XslCompiledTransformDescriptorBuilder"/> that knows how to build the various constituents of the <see
		/// cref="XslCompiledTransformDescriptor"/> for a given <see cref="TransformBase"/>-derived transform.
		/// </param>
		...
		/// </summary>
		/// <remarks>
		/// The <see cref="IXmlNamespaceResolver"/> resolver will automatically resolve all of the namespaces declared in the
		/// stylesheet markup of <see cref="XslCompiledTransform"/> and is therefore suited to help <see
